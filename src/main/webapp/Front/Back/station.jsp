                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/back/showTrain"><i class="fa fa-desktop"></i> 车次信息</a>
          					...
          					<li>
                        <a href="${pageContext.request.contextPath}/back/showStation" class="active-menu"><i class="fa fa-bar-chart-o"></i> 车站信息</a>
                    </li>
                    <!-- <li>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th width="80px">路线编号</th>
                                            <th width="80px">动车名称</th>
                                            <th>车次路线</th>
                                            <th width="80px">路线站数</th>
                                            <th>操作</th>
                                        </tr>
                                    </thead>
                                    
                                    <tbody>
                                     <c:if test="${requestScope.stationList != null}">
                                    <c:forEach items="${stationList}" var="stationList"> 
                                    
										<tr>
										<td>${stationList.id}</td>
										<td>${stationList.trainNo}</td>
										<td>${stationList.stations}</td>
										<td>${stationList.size}</td>
